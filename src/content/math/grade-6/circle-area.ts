...
const circleArea: ChapterV2 = {
  ...
  finalPractice: [
    ...
    { type: 'mc', q: 'ค่า π ประมาณเท่าไร?', opts: ['2.14', '3.14', '4.14', '1.14'], ans: 1, hint: 'สามจุดหนึ่งสี่' },
    ...
    { type: 'mc', q: 'พื้นที่วงกลมใช้สูตรใด?', opts: ['π × r × r', '2 × π × r', 'กว้าง × ยาว', 'ด้าน × 4'], ans: 0, hint: 'πr²' },
    { type: 'fill', q: 'วงกลมรัศมี 10 พื้นที่ = 3.14×10×10 = ___', ans: '314', hint: 'π × 100' },
    { type: 'mc', q: 'เส้นรอบวงใช้สูตรใด?', opts: ['2 × π × r', 'π × r × r', 'กว้าง×ยาว', 'r × r'], ans: 0, hint: '2πr' },
