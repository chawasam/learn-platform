...
const percent: ChapterV2 = {
  ...
  finalPractice: [
    ...
    { type: 'fill', q: 'ขาย 90 ชิ้น จากทั้งหมด 120 ชิ้น คิดเป็น ___% ที่ขายได้', ans: '75', hint: '90÷120×100=75' },
    ...
    { type: 'slider', q: '15% ของ 200 = ?', min: 0, max: 50, step: 5, ans: 30, unit: 'บาท', hint: '200×15÷100=30' },
