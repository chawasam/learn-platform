...
const templates: QuestionTemplate[] = [
  ...
  // ดอกเบี้ย
  { id: 'interest', difficulty: 3, gen: r => {
    const N = 100 * ri(r, 2, 30), p = ri(r, 1, 10), v = (N * p) / 100
    return mcNum(r, `ฝากเงิน ${N} บาท ดอกเบี้ย ${p}% ต่อปี 1 ปีได้ดอกเบี้ยกี่บาท`, v, [N + v, p, v * 2], baht, `${p}/100 × ${N}`)
  } },
