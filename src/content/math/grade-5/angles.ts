...
// ป.5 บท 2 มุม (ref: p5-c02) — แหลม/ฉาก/ป้าน/ตรง ด้วย AngleDrag (ลากอิสระ)
const angles: ChapterV2 = {
  ...
  finalPractice: [
    ...
    { type: 'fill', q: 'มุมฉากมีขนาดกี่องศา? ___', ans: '90', hint: 'มุมห้อง' },
    { type: 'mc', q: 'มุมใดเล็กที่สุด?', opts: ['30°', '90°', '120°', '180°'], ans: 0, hint: 'องศายิ่งน้อยยิ่งแคบ' },
    { type: 'mc', q: 'เข็มนาฬิกาบอก 3 โมงตรง เข็มสองเข็มทำมุมกี่องศา?', opts: ['45°', '90°', '180°', '60°'], ans: 1, hint: 'เข็มชี้ 12 กับ 3 = มุมฉาก' },
    { type: 'fill', q: 'มุม 45° เป็นครึ่งหนึ่งของมุม ___ องศา', ans: '90', hint: '45 × 2' },
    { type: 'mc', q: 'มุม 89° เป็นมุมประเภทใด?', opts: ['มุมแหลม', 'มุมฉาก', 'มุมป้าน', 'มุมตรง'], ans: 0, hint: 'ยังไม่ถึง 90' },
    { type: 'slider', q: 'มุมฉากมีขนาดกี่องศา? ลากเลือก', min: 0, max: 180, step: 10, ans: 90, unit: '°', hint: 'มุมห้อง = ครึ่งของมุมตรง' },
  ],
}
