...
const divide: ChapterV2 = {
  ...
  finalPractice: [
    { type: 'mc', q: '120 ÷ 4 = ?', opts: ['30', '24', '40', '20'], ans: 0, hint: '12÷4=3 แล้วเติม 0 → 30' },
    { type: 'fill', q: 'ดินสอ 105 แท่ง แบ่งใส่กล่อง 5 กล่องเท่าๆ กัน กล่องละ ___ แท่ง', ans: '21', hint: '10÷5=2 เหลือ 0 → 05÷5=1 → ผล 21' },
    ...
    { type: 'fill', q: '___ ÷ 6 = 14', ans: '84', hint: '6 × 14 = 84' },
    ...
    { type: 'slider', q: '540 ÷ 6 = ?', min: 0, max: 100, step: 10, ans: 90, unit: '', hint: '54÷6=9 แล้วเติม 0 → 90' },
