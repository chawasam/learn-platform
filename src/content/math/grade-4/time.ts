...
const time: ChapterV2 = {
  ...
  finalPractice: [
    ...
    { type: 'fill', q: 'เรียนเริ่ม 9 โมง เลิก 3 โมงเย็น (15 โมง) เรียนกี่ชั่วโมง?', ans: '6', hint: '15 − 9 = ?' },
    { type: 'mc', q: '2 ชั่วโมงครึ่ง = กี่นาที?', opts: ['120 นาที', '150 นาที', '130 นาที', '90 นาที'], ans: 1, hint: '2×60 + 30 = ?' },
    { type: 'fill', q: 'นอน 4 ทุ่ม (22:00) ตื่น 6 โมงเช้า (06:00) นอนกี่ชั่วโมง?', ans: '8', hint: 'นับจาก 22 ถึง 24 = 2 ชม. แล้ว +6 = ?' },
  ],
}
